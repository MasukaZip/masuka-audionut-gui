    ...
    <div className="p-8 max-w-4xl mx-auto space-y-8 text-gray-300">
      ...
      <div className="card border border-gray-700 bg-gray-800/50 mt-12">
        ...
        <p className="leading-relaxed text-sm">
          Este aplicativo é uma interface gráfica moderna e ágil (GUI) desenhada para facilitar a automação de uploads e padronizações. O motor principal do software, responsável pela comunicação com trackers e automações de mídia, é o poderoso script <strong>Upload-Assistant</strong> escrito originalmente em Python. Para uploads de cursos, ebooks e vídeos, a interface integra o script <strong>PR1MATE PDF</strong> como motor auxiliar.
        </p>
      </div>
      ...
      <div className="card border border-blue-900/40 bg-blue-900/10 shadow-[0_0_15px_rgba(30,58,138,0.2)]">
        ...
        <div className="border-t border-blue-900/40 mt-6 pt-6">
          <p className="text-sm mb-4">
            O motor por trás da aba <strong>PR1MATE PDF</strong>, responsável pelo upload de cursos, ebooks e vídeos, é desenvolvido pelo dev <strong>n1njapr1mate</strong>.
          </p>
          <a
            href="https://gitlab.com/n1njapr1mate/pr1mate-pdf"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-sm text-blue-300 hover:text-white transition-colors bg-blue-900/30 px-4 py-2 rounded border border-blue-500/30 hover:bg-blue-600/50"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M4.845.904a.9.9 0 00-.857.63L.09 13.073a.9.9 0 00.328 1.006l11.339 8.23a.9.9 0 001.07 0l11.339-8.23a.9.9 0 00.328-1.006L20.012 1.534a.9.9 0 00-.857-.63.9.9 0 00-.857.63l-2.957 9.09H8.659L5.702 1.534A.9.9 0 004.845.904z"/></svg>
            Visitar repositório original (PR1MATE PDF)
          </a>
        </div>
      </div>
